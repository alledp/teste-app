...
public class RestServiceImpl <T> implements RestService<T> {
    ...
    public int post(String resource, T entity) {
        ...
        try {
            ...
            final ResponseEntity<String> responseEntity = restTemplate.exchange(resource,
                    HttpMethod.POST,
                    httpEntity,
                    String.class);
    ...
    public boolean put(String resource, T entity) {
        ...
        try{
            ...
            final ResponseEntity<Boolean> responseEntity = restTemplate.exchange(resource,
                    HttpMethod.PUT,
                    httpEntity,
                    Boolean.class);
...
//            String lalala = "kkk";
//            String resposta = lalala.equals("kkk") ? "chupetinha" : "outracoisa";
